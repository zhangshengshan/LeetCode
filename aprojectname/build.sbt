...
val gh = GitHubSettings(org = "com.YourOrgName", proj = "aProjectName", publishOrg = "com.YourOrgName", license = apache2)
...
lazy val Aprojectname = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "aProjectName"),
    micrositeDocumentationUrl := "/aProjectName/api/com.YourOrgName/index.html",
